...
<div class="col-sm-12 col-md-12 col-lg-12 text-center">
              <form id="loginform" action="#" method="post">
                ...
                <div class="row">
                  <div class="col">
                    <p class="white"><b>Account Number </b></p>
                  </div>
                  <div class="col">
                    <input type="text" id="ano" class="form-control border-light rounded-pill w-75" name="ano" minlength="6" required>
                  </div>
                </div>
                <br>
				 <div class="row">
                  <div class="col">
                    <p class="white"><b>Account Type</b></p>
                  </div>
                  <div class="col">
                  <select class="form-control border-light rounded-pill w-75"" id="atype" name="atype" required>
    ...
    <option value="collection">Collection</option>
                ...
                <div class="row">
                  <div class="col">
                    <p class="white"><b>Date</b></p>
                  </div>
                  <div class="col">
                  <input type="date" class="form-control border-light rounded-pill w-75" id="date" name="date" required>
                  </div>
                </div><br>
                <div class="row">
                  <div class="col">
                    <p class="white"><b>Amount</b></p>
                  </div>
                  <div class="col">
                  <select class="form-control border-light rounded-pill w-75"" id="amount" name="amount" required>
